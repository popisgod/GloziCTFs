...
class Broadcast<E> extends AbstractCoroutine<Unit> implements ProducerScope<E>, BroadcastChannel<E> {
    ...
    public Object mo1669trySendJP2dKIU(E e) {
        return this._channel.mo1669trySendJP2dKIU(e);
    }

    public Broadcast(CoroutineContext coroutineContext, BroadcastChannel<E> broadcastChannel, boolean z) {
    ...
    public final /* synthetic */ boolean cancel(Throwable th) {
        if (th == null) {
            Broadcast<E> broadcast = this;
            th = new JobCancellationException(broadcast.cancellationExceptionMessage(), null, broadcast);
        }
        cancelInternal(th);
        return true;
    }
    ...
    public final void cancel(CancellationException cancellationException) {
        if (cancellationException == null) {
            Broadcast<E> broadcast = this;
            cancellationException = new JobCancellationException(broadcast.cancellationExceptionMessage(), null, broadcast);
        }
