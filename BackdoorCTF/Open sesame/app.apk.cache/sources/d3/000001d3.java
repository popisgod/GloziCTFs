...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0028R.styleable.ActivityChooserView, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0028R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0028R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0028R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0028R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        ...
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0028R.C0031id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C0028R.C0031id.image);
    ...
    void showPopupUnchecked(int i) {
        ...
        listPopupWindow.getListView().setContentDescription(getContext().getString(C0028R.string.abc_activitychooserview_choose_application));
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    if (view == null || view.getId() != 1) {
                        View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0028R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                        inflate.setId(1);
                        ((TextView) inflate.findViewById(C0028R.C0031id.title)).setText(ActivityChooserView.this.getContext().getString(C0028R.string.abc_activity_chooser_view_see_all));
                        return inflate;
                    }
                    return view;
                }
            ...
            if (view == null || view.getId() != C0028R.C0031id.list_item) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0028R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
            ((ImageView) view.findViewById(C0028R.C0031id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(C0028R.C0031id.title)).setText(resolveInfo.loadLabel(packageManager));
