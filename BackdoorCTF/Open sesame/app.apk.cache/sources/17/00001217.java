...
public final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public <U, S> Object callRecursive(DeepRecursive<U, S> deepRecursive, U u, Continuation<? super S> continuation) {
        Function3<DeepRecursiveScope<U, S>, U, Continuation<? super S>, Object> block$kotlin_stdlib = deepRecursive.getBlock$kotlin_stdlib();
    ...
    public final R runCallLoop() {
        ...
        while (true) {
            ...
            obj = DeepRecursiveKt.UNDEFINED_RESULT;
            if (Result.m180equalsimpl0(obj, r)) {
                try {
                    Function3<? super DeepRecursiveScope<?, ?>, Object, ? super Continuation<Object>, ? extends Object> function3 = this.function;
                    ...
                    if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        ...
                        continuation.resumeWith(Result.m178constructorimpl(invoke));
                    }
                } catch (Throwable th) {
