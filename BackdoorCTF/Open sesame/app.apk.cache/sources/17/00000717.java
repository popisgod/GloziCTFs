...
public final class SparseArray {
    ...
    public static final <T> android.util.SparseArray<T> plus(android.util.SparseArray<T> sparseArray, android.util.SparseArray<T> other) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
        android.util.SparseArray<T> sparseArray2 = new android.util.SparseArray<>(sparseArray.size() + other.size());
    ...
    public static final <T> T getOrElse(android.util.SparseArray<T> sparseArray, int i, Functions<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
    ...
    public static final <T> void forEach(android.util.SparseArray<T> sparseArray, Function2<? super Integer, ? super T, Unit> action) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
    ...
    public static final <T> IntIterator keyIterator(final android.util.SparseArray<T> sparseArray) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
    ...
    public static final <T> Iterator<T> valueIterator(android.util.SparseArray<T> sparseArray) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        return new SparseArrayKt$valueIterator$1(sparseArray);
    }

    public static final <T> void putAll(android.util.SparseArray<T> sparseArray, android.util.SparseArray<T> other) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
        int size = other.size();
        for (int i = 0; i < size; i++) {
