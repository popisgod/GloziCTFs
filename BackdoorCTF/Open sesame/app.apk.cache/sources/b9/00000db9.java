...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private static final int DEF_STYLE_RES = C0572R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0572R.attr.chipStyle);
    }
    ...
    */
    public Chip(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            ...
            r7.setElevation(r1)
            int[] r2 = com.google.android.material.C0572R.styleable.Chip
            r1 = 0
            int[] r5 = new int[r1]
            r1 = r8
            r3 = r9
            android.content.res.TypedArray r8 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r9 = com.google.android.material.C0572R.styleable.Chip_shapeAppearance
    ...
    public /* synthetic */ void m170lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton compoundButton, boolean z) {
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0572R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = obtainStyledAttributes.getBoolean(C0572R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil(obtainStyledAttributes.getDimension(C0572R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48))));
        ...
        protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = C0572R.string.mtrl_chip_close_icon_content_description;
