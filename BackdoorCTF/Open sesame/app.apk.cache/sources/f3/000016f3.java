        ...
        if (obj != null) {
            if (!(obj instanceof ArrayList)) {
                ...
                if (send instanceof AbstractSendChannel.SendBuffered) {
                    ...
                    if (function1 != null) {
                        undeliveredElementException = OnUndeliveredElement.callUndeliveredElementCatchingException(function1, ((AbstractSendChannel.SendBuffered) send).element, null);
                    }
                } else {
                ...
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    ...
                    if (send2 instanceof AbstractSendChannel.SendBuffered) {
                        ...
                        undeliveredElementException2 = function12 != null ? OnUndeliveredElement.callUndeliveredElementCatchingException(function12, ((AbstractSendChannel.SendBuffered) send2).element, undeliveredElementException2) : null;
                    } else {
