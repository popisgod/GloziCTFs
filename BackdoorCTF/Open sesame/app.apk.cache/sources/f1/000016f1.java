...
final class LazyActorCoroutine<E> extends Actor<E> implements SelectClause2<E, SendChannel<? super E>> {
    ...
    protected void onStart() {
        Cancellable.startCoroutineCancellable(this.continuation, this);
    }
    ...
    public Object mo1669trySendJP2dKIU(E e) {
        start();
        return super.mo1669trySendJP2dKIU(e);
    }
