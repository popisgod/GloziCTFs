...
public class ConstraintWidget {
    ...
    public int getX() {
        ...
        return (constraintWidget == null || !(constraintWidget instanceof ConstraintWidgetContainer)) ? this.f38mX : ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f38mX;
    }

    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        return (constraintWidget == null || !(constraintWidget instanceof ConstraintWidgetContainer)) ? this.f39mY : ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f39mY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C01481.f40x6930e354[type.ordinal()];
        if (i2 == 1) {
    ...
    */
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append("\n");
        sb.append("    actualLeft:" + this.f38mX);
        sb.append("\n");
        sb.append("    actualTop:" + this.f39mY);
        sb.append("\n");
