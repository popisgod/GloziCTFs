...
class StandardKt__StandardKt {
    ...
    private static final Void TODO(String reason) {
        ...
        throw new Standard("An operation is not implemented: " + reason);
    }

    private static final <R> R run(Functions<? extends R> block) {
