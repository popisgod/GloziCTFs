...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m1779SupervisorJob(Job job) {
        return SupervisorJob(job);
    }

    /* renamed from: SupervisorJob$default  reason: collision with other method in class */
    public static /* synthetic */ Job m1780SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m1779SupervisorJob(job);
    }
    ...
    public static final <R> Object supervisorScope(Function2<? super CoroutineScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        Supervisor supervisor = new Supervisor(continuation.getContext(), continuation);
        Object startUndispatchedOrReturn = Undispatched.startUndispatchedOrReturn(supervisor, supervisor, function2);
