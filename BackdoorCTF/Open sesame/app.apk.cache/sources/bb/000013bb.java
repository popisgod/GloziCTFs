        ...
        try {
            ...
            if (i2 > 0) {
                ...
                if (read2 != -1) {
                    ...
                    IOStreams.copyTo$default(fileInputStream2, fileReadWrite, 0, 2, null);
                    ...
                    bArr = ArraysKt.copyInto(buffer, copyOf, i, 0, fileReadWrite.size());
                }
            }
