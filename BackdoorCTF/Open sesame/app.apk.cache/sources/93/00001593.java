...
public class StringsKt__StringsKt extends StringsJVM {
    ...
    public static final Tuples<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
        ...
        if (!z && collection.size() == 1) {
            ...
            return TuplesKt.m18to(Integer.valueOf(indexOf$default), str);
        }
            ...
            if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                while (true) {
                    ...
                    if (str3 == null) {
                        ...
                        return TuplesKt.m18to(Integer.valueOf(first), str3);
                    }
                }
            }
        } else {
            ...
            if ((step2 > 0 && first2 <= last2) || (step2 < 0 && last2 <= first2)) {
                while (true) {
                    ...
                    if (str5 == null) {
                        ...
                        return TuplesKt.m18to(Integer.valueOf(first2), str5);
                    }
                }
            }
        }
    ...
    public static final Tuples<Integer, String> findAnyOf(CharSequence charSequence, Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
    ...
    public static final Tuples<Integer, String> findLastAnyOf(CharSequence charSequence, Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
    ...
    public static final int indexOfAny(CharSequence charSequence, Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
        Tuples<Integer, String> findAnyOf$StringsKt__StringsKt = findAnyOf$StringsKt__StringsKt(charSequence, strings, i, z, false);
    ...
    public static final int lastIndexOfAny(CharSequence charSequence, Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
        Tuples<Integer, String> findAnyOf$StringsKt__StringsKt = findAnyOf$StringsKt__StringsKt(charSequence, strings, i, z, true);
        if (findAnyOf$StringsKt__StringsKt != null) {
            return findAnyOf$StringsKt__StringsKt.getFirst().intValue();
        }
        return -1;
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence charSequence, final char[] cArr, int i, final boolean z, int i2) {
        ...
        return new Strings(charSequence, i, i2, new Function2<CharSequence, Integer, Tuples<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$1
            ...
            public final Tuples<Integer, Integer> invoke(CharSequence $receiver, int i3) {
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                int indexOfAny = StringsKt.indexOfAny($receiver, cArr, i3, z);
                if (indexOfAny < 0) {
                    return null;
                }
                return TuplesKt.m18to(Integer.valueOf(indexOfAny), 1);
            }
        });
    }
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence charSequence, String[] strArr, int i, final boolean z, int i2) {
        ...
        return new Strings(charSequence, i, i2, new Function2<CharSequence, Integer, Tuples<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final Tuples<Integer, Integer> invoke(CharSequence $receiver, int i3) {
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                Tuples access$findAnyOf = StringsKt__StringsKt.access$findAnyOf($receiver, asList, i3, z, false);
                if (access$findAnyOf != null) {
                    return TuplesKt.m18to(access$findAnyOf.getFirst(), Integer.valueOf(((String) access$findAnyOf.getSecond()).length()));
                }
                return null;
            }
        });
