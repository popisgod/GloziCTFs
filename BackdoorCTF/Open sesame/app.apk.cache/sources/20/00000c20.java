...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo1766clone = transition.mo1766clone();
        mo1766clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo1766clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo1766clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo1766clone);
    }
    ...
    /* renamed from: go */
    public static void m103go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m102go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo1766clone = transition.mo1766clone();
        sceneChangeSetup(viewGroup, mo1766clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo1766clone);
    }
