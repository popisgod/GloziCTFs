...
public final class ViewKt {
    ...
    public static final Runnable postDelayed(View view, long j, final Functions<Unit> action) {
        Intrinsics.checkNotNullParameter(view, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
    ...
    public static final Runnable postOnAnimationDelayed(View view, long j, final Functions<Unit> action) {
        Intrinsics.checkNotNullParameter(view, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        Runnable runnable = new Runnable() { // from class: androidx.core.view.ViewKt$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ViewKt.$r8$lambda$Y6wGMU_rQCvb5uOg5WbipwD8gCc(action);
            }
        };
        View.postOnAnimationDelayed(view, runnable, j);
        return runnable;
    }

    /* renamed from: postOnAnimationDelayed$lambda-1 */
    public static final void m162postOnAnimationDelayed$lambda1(Functions action) {
        Intrinsics.checkNotNullParameter(action, "$action");
        action.invoke();
    }
