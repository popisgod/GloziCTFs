...
public final class LongSparseArray {
    ...
    public static final <T> T getOrElse(android.util.LongSparseArray<T> longSparseArray, long j, Functions<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(longSparseArray, "<this>");
    ...
    public static final <T> void forEach(android.util.LongSparseArray<T> longSparseArray, Function2<? super Long, ? super T, Unit> action) {
        Intrinsics.checkNotNullParameter(longSparseArray, "<this>");
    ...
    public static final <T> LongIterator keyIterator(final android.util.LongSparseArray<T> longSparseArray) {
        Intrinsics.checkNotNullParameter(longSparseArray, "<this>");
    ...
    public static final <T> Iterator<T> valueIterator(android.util.LongSparseArray<T> longSparseArray) {
        Intrinsics.checkNotNullParameter(longSparseArray, "<this>");
