...
public final class FlowKt__ZipKt$combineTransform$7<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C09841<T> extends Lambda implements Functions<T[]> {
        final /* synthetic */ Flow<T>[] $flowArray;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C09841(Flow<T>[] flowArr) {
            super(0);
            this.$flowArray = flowArr;
        }
    ...
    /* loaded from: classes.dex */
    public static final class C09852<T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        final /* synthetic */ Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> $transform;
        private /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C09852(Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C09852> continuation) {
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C09852 c09852 = new C09852(this.$transform, continuation);
            c09852.L$0 = flowCollector;
            c09852.L$1 = tArr;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Intrinsics.needClassReification();
            this.label = 1;
            if (Combine.combineInternal((FlowCollector) this.L$0, flowArr, new C09841(this.$flowArray), new C09852(this.$transform, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        Combine.combineInternal((FlowCollector) this.L$0, flowArr, new C09841(this.$flowArray), new C09852(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}