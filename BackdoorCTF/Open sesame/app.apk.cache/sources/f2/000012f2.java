...
public class MapsKt__MapsKt extends MapsJVM {
    ...
    public static final <K, V> Map<K, V> mutableMapOf(Tuples<? extends K, ? extends V>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
    ...
    public static final <K, V> HashMap<K, V> hashMapOf(Tuples<? extends K, ? extends V>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
    ...
    public static final <K, V> LinkedHashMap<K, V> linkedMapOf(Tuples<? extends K, ? extends V>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
    ...
    private static final Object ifEmpty(Map map, Functions defaultValue) {
    ...
    public static final <K, V> V getOrElseNullable(Map<K, ? extends V> map, K k, Functions<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v = map.get(k);
    ...
    public static final <K, V> V getOrPut(Map<K, V> map, K k, Functions<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v = map.get(k);
        if (v == null) {
    ...
    public static final <K, V> void putAll(Map<? super K, ? super V> map, Tuples<? extends K, ? extends V>[] pairs) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        for (Tuples<? extends K, ? extends V> tuples : pairs) {
            map.put((K) tuples.component1(), (V) tuples.component2());
        }
    }

    public static final <K, V> void putAll(Map<? super K, ? super V> map, Iterable<? extends Tuples<? extends K, ? extends V>> pairs) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        for (Tuples<? extends K, ? extends V> tuples : pairs) {
            map.put((K) tuples.component1(), (V) tuples.component2());
    ...
    public static final <K, V> void putAll(Map<? super K, ? super V> map, Sequence<? extends Tuples<? extends K, ? extends V>> pairs) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        for (Tuples<? extends K, ? extends V> tuples : pairs) {
            map.put((K) tuples.component1(), (V) tuples.component2());
    ...
    public static final <K, V> Map<K, V> toMap(Iterable<? extends Tuples<? extends K, ? extends V>> iterable) {
        ...
        if (iterable instanceof Collection) {
            ...
            if (size != 0) {
                ...
                return MapsKt.mapOf(iterable instanceof List ? (Tuples<? extends K, ? extends V>) ((List) iterable).get(0) : iterable.iterator().next());
            }
            return MapsKt.emptyMap();
        }
    ...
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(Iterable<? extends Tuples<? extends K, ? extends V>> iterable, M destination) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
    ...
    public static final <K, V> Map<K, V> toMap(Tuples<? extends K, ? extends V>[] tuplesArr) {
    ...
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(Tuples<? extends K, ? extends V>[] tuplesArr, M destination) {
        Intrinsics.checkNotNullParameter(tuplesArr, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
    ...
    public static final <K, V> Map<K, V> toMap(Sequence<? extends Tuples<? extends K, ? extends V>> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return MapsKt.optimizeReadOnlyMap(MapsKt.toMap(sequence, new LinkedHashMap()));
    }

    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(Sequence<? extends Tuples<? extends K, ? extends V>> sequence, M destination) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
    ...
    public static final <K, V> Map<K, V> plus(Map<? extends K, ? extends V> map, Tuples<? extends K, ? extends V> pair) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    public static final <K, V> Map<K, V> plus(Map<? extends K, ? extends V> map, Iterable<? extends Tuples<? extends K, ? extends V>> pairs) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        if (map.isEmpty()) {
    ...
    public static final <K, V> Map<K, V> plus(Map<? extends K, ? extends V> map, Tuples<? extends K, ? extends V>[] pairs) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        if (map.isEmpty()) {
            return MapsKt.toMap(pairs);
    ...
    public static final <K, V> Map<K, V> plus(Map<? extends K, ? extends V> map, Sequence<? extends Tuples<? extends K, ? extends V>> pairs) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        LinkedHashMap linkedHashMap = new LinkedHashMap(map);
        MapsKt.putAll(linkedHashMap, pairs);
