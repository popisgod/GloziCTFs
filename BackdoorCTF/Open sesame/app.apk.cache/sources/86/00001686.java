...
import kotlinx.coroutines.intrinsics.Cancellable;
...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    protected Object pollInternal() {
        while (true) {
            ...
            if (tryResumeSend != null) {
                if (!Debug.getASSERTIONS_ENABLED() || tryResumeSend == CancellableContinuationImplKt.RESUME_TOKEN) {
    ...
    */
    public final java.lang.Object mo1667receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r5 = r0.m1687closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m1689successJP2dKIU(r5)
        L52:
            return r5
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            java.lang.Object r5 = r5.m1686unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1667receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk */
    public final Object mo1668tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1688failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m1687closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1689successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                if (Debug.getASSERTIONS_ENABLED() && !(prevNode instanceof Send)) {
                    throw new AssertionError();
                }
                if (!prevNode.mo1782remove()) {
                    prevNode.helpRemove();
                } else {
                    m1705constructorimpl$default = InlineList.m1710plusFjFbRPM(m1705constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1666onCancelIdempotentListww6eGU(m1705constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i != 1) {
                Undispatched.startCoroutineUnintercepted(function2, obj, selectInstance.getCompletion());
                return;
            }
            ChannelResult.Companion companion = ChannelResult.Companion;
            Undispatched.startCoroutineUnintercepted(function2, ChannelResult.m1674boximpl(z ? companion.m1687closedJP2dKIU(((Closed) obj).closeCause) : companion.m1689successJP2dKIU(obj)), selectInstance.getCompletion());
        } else if (i == 0) {
            throw StackTraceRecovery.recoverStackTrace(((Closed) obj).getReceiveException());
        } else {
            if (i == 1 && selectInstance.trySelect()) {
                Undispatched.startCoroutineUnintercepted(function2, ChannelResult.m1674boximpl(ChannelResult.Companion.m1687closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        }
    }
    ...
    /* compiled from: AbstractChannel.kt */
    @Metadata(m26d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0011\u0012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003¢\u0006\u0002\u0010\u0004J\u0013\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0096\u0002J\b\u0010\t\u001a\u00020\nH\u0016R\u0012\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m25d2 = {"Lkotlinx/coroutines/channels/AbstractChannel$RemoveReceiveOnCancel;", "Lkotlinx/coroutines/BeforeResumeCancelHandler;", "receive", "Lkotlinx/coroutines/channels/Receive;", "(Lkotlinx/coroutines/channels/AbstractChannel;Lkotlinx/coroutines/channels/Receive;)V", "invoke", "", "cause", "", "toString", "", "kotlinx-coroutines-core"}, m24k = 1, m23mv = {1, 6, 0}, m21xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    public static final class Itr<E> implements ChannelIterator<E> {
        ...
        private final boolean hasNextResult(Object obj) {
            if (obj instanceof Closed) {
                ...
                throw StackTraceRecovery.recoverStackTrace(closed.getReceiveException());
            }
            return true;
        }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m178constructorimpl(boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuationImpl.resumeWith(Result.m178constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
                } else if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean = boxing.boxBoolean(true);
                    Function1<E, Unit> function1 = this.channel.onUndeliveredElement;
                    cancellableContinuationImpl.resume(boxBoolean, function1 != null ? OnUndeliveredElement.bindCancellationFun(function1, pollInternal, cancellableContinuationImpl.getContext()) : null);
                }
            }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1674boximpl(ChannelResult.Companion.m1689successJP2dKIU(e)) : e;
        }
        ...
        public Symbol tryResumeReceive(E e, LockFreeLinkedListNode.PrepareOp prepareOp) {
            ...
            if (!Debug.getASSERTIONS_ENABLED() || tryResume == CancellableContinuationImplKt.RESUME_TOKEN) {
                if (prepareOp != null) {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m178constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            ChannelResult m1674boximpl = ChannelResult.m1674boximpl(ChannelResult.Companion.m1687closedJP2dKIU(closed.closeCause));
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m178constructorimpl(m1674boximpl));
        }
    ...
    public static final class ReceiveElementWithUndeliveredHandler<E> extends ReceiveElement<E> {
        ...
        public Function1<Throwable, Unit> resumeOnCancellationFun(E e) {
            return OnUndeliveredElement.bindCancellationFun(this.onUndeliveredElement, e, this.cont.getContext());
        }
    }
    ...
    public static class ReceiveHasNext<E> extends Receive<E> {
        ...
        public Function1<Throwable, Unit> resumeOnCancellationFun(E e) {
            ...
            if (function1 != null) {
                return OnUndeliveredElement.bindCancellationFun(function1, e, this.cont.getContext());
            }
            return null;
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            Cancellable.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1674boximpl(ChannelResult.Companion.m1689successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    Cancellable.startCoroutineCancellable$default(this.block, ChannelResult.m1674boximpl(ChannelResult.Companion.m1687closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
        ...
        public Function1<Throwable, Unit> resumeOnCancellationFun(E e) {
            Function1<E, Unit> function1 = this.channel.onUndeliveredElement;
            if (function1 != null) {
                return OnUndeliveredElement.bindCancellationFun(function1, e, this.select.getCompletion().getContext());
            }
            return null;
        }
    ...
    protected void mo1666onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
