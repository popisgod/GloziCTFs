...
class _UArraysJvm {
    ...
    public static final int m645binarySearch2fe2U9s(int[] binarySearch, int i, int i2, int i3) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i2, i3, UIntArray.m334getSizeimpl(binarySearch));
        int i4 = i3 - 1;
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
    ...
    public static /* synthetic */ int m650binarySearchK6DWlUc$default(long[] jArr, long j, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = ULongArray.m413getSizeimpl(jArr);
        }
        return UArraysKt.m649binarySearchK6DWlUc(jArr, j, i, i2);
    }

    /* renamed from: binarySearch-K6DWlUc */
    public static final int m649binarySearchK6DWlUc(long[] binarySearch, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, ULongArray.m413getSizeimpl(binarySearch));
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static final int m651binarySearchWpHrYlw(byte[] binarySearch, byte b, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, UByteArray.m255getSizeimpl(binarySearch));
    ...
    public static /* synthetic */ int m648binarySearchEtDCXyQ$default(short[] sArr, short s, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = UShortArray.m518getSizeimpl(sArr);
        }
        return UArraysKt.m647binarySearchEtDCXyQ(sArr, s, i, i2);
    }

    /* renamed from: binarySearch-EtDCXyQ */
    public static final int m647binarySearchEtDCXyQ(short[] binarySearch, short s, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, UShortArray.m518getSizeimpl(binarySearch));
    ...
    public static final /* synthetic */ UInt m657maxajY9A(int[] max) {
        ...
        return UArraysKt.m1037maxOrNullajY9A(max);
    }
    ...
    public static final /* synthetic */ ULong m659maxQwZRm1k(long[] max) {
        Intrinsics.checkNotNullParameter(max, "$this$max");
        return UArraysKt.m1039maxOrNullQwZRm1k(max);
    }
    ...
    public static final /* synthetic */ UByte m658maxGBYM_sE(byte[] max) {
        Intrinsics.checkNotNullParameter(max, "$this$max");
        return UArraysKt.m1038maxOrNullGBYM_sE(max);
    }
    ...
    public static final /* synthetic */ UShort m660maxrL5Bavg(short[] max) {
        Intrinsics.checkNotNullParameter(max, "$this$max");
        return UArraysKt.m1040maxOrNullrL5Bavg(max);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m663maxByjgv0xPQ(int[] maxBy, Function1<? super UInt, ? extends R> selector) {
        ...
        if (UIntArray.m336isEmptyimpl(maxBy)) {
            return null;
        }
        int m333getpVg5ArA = UIntArray.m333getpVg5ArA(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UInt.m267boximpl(m333getpVg5ArA));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                int m333getpVg5ArA2 = UIntArray.m333getpVg5ArA(maxBy, it.nextInt());
                R invoke2 = selector.invoke(UInt.m267boximpl(m333getpVg5ArA2));
                if (invoke.compareTo(invoke2) < 0) {
                    m333getpVg5ArA = m333getpVg5ArA2;
                    invoke = invoke2;
                }
            }
        }
        return UInt.m267boximpl(m333getpVg5ArA);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m662maxByMShoTSo(long[] maxBy, Function1<? super ULong, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(maxBy, "$this$maxBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (ULongArray.m415isEmptyimpl(maxBy)) {
            return null;
        }
        long m412getsVKNKU = ULongArray.m412getsVKNKU(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(ULong.m346boximpl(m412getsVKNKU));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                long m412getsVKNKU2 = ULongArray.m412getsVKNKU(maxBy, it.nextInt());
                R invoke2 = selector.invoke(ULong.m346boximpl(m412getsVKNKU2));
                if (invoke.compareTo(invoke2) < 0) {
                    m412getsVKNKU = m412getsVKNKU2;
                    invoke = invoke2;
                }
            }
        }
        return ULong.m346boximpl(m412getsVKNKU);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m661maxByJOV_ifY(byte[] maxBy, Function1<? super UByte, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(maxBy, "$this$maxBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UByteArray.m257isEmptyimpl(maxBy)) {
            return null;
        }
        byte m254getw2LRezQ = UByteArray.m254getw2LRezQ(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UByte.m190boximpl(m254getw2LRezQ));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                byte m254getw2LRezQ2 = UByteArray.m254getw2LRezQ(maxBy, it.nextInt());
                R invoke2 = selector.invoke(UByte.m190boximpl(m254getw2LRezQ2));
                if (invoke.compareTo(invoke2) < 0) {
                    m254getw2LRezQ = m254getw2LRezQ2;
                    invoke = invoke2;
                }
            }
        }
        return UByte.m190boximpl(m254getw2LRezQ);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m664maxByxTcfx_M(short[] maxBy, Function1<? super UShort, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(maxBy, "$this$maxBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UShortArray.m520isEmptyimpl(maxBy)) {
            return null;
        }
        short m517getMh2AYeg = UShortArray.m517getMh2AYeg(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UShort.m453boximpl(m517getMh2AYeg));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                short m517getMh2AYeg2 = UShortArray.m517getMh2AYeg(maxBy, it.nextInt());
                R invoke2 = selector.invoke(UShort.m453boximpl(m517getMh2AYeg2));
                if (invoke.compareTo(invoke2) < 0) {
                    m517getMh2AYeg = m517getMh2AYeg2;
                    invoke = invoke2;
                }
            }
        }
        return UShort.m453boximpl(m517getMh2AYeg);
    }
    ...
    public static final /* synthetic */ UInt m666maxWithYmdZ_VM(int[] maxWith, Comparator comparator) {
        ...
        return UArraysKt.m1046maxWithOrNullYmdZ_VM(maxWith, comparator);
    }
    ...
    public static final /* synthetic */ ULong m668maxWithzrEWJaI(long[] maxWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(maxWith, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1048maxWithOrNullzrEWJaI(maxWith, comparator);
    }
    ...
    public static final /* synthetic */ UByte m665maxWithXMRcp5o(byte[] maxWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(maxWith, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1045maxWithOrNullXMRcp5o(maxWith, comparator);
    }
    ...
    public static final /* synthetic */ UShort m667maxWitheOHTfZs(short[] maxWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(maxWith, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1047maxWithOrNulleOHTfZs(maxWith, comparator);
    }
    ...
    public static final /* synthetic */ UInt m669minajY9A(int[] min) {
        ...
        return UArraysKt.m1093minOrNullajY9A(min);
    }
    ...
    public static final /* synthetic */ ULong m671minQwZRm1k(long[] min) {
        Intrinsics.checkNotNullParameter(min, "$this$min");
        return UArraysKt.m1095minOrNullQwZRm1k(min);
    }
    ...
    public static final /* synthetic */ UByte m670minGBYM_sE(byte[] min) {
        Intrinsics.checkNotNullParameter(min, "$this$min");
        return UArraysKt.m1094minOrNullGBYM_sE(min);
    }
    ...
    public static final /* synthetic */ UShort m672minrL5Bavg(short[] min) {
        Intrinsics.checkNotNullParameter(min, "$this$min");
        return UArraysKt.m1096minOrNullrL5Bavg(min);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m675minByjgv0xPQ(int[] minBy, Function1<? super UInt, ? extends R> selector) {
        ...
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UIntArray.m336isEmptyimpl(minBy)) {
            return null;
        }
        int m333getpVg5ArA = UIntArray.m333getpVg5ArA(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UInt.m267boximpl(m333getpVg5ArA));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                int m333getpVg5ArA2 = UIntArray.m333getpVg5ArA(minBy, it.nextInt());
                R invoke2 = selector.invoke(UInt.m267boximpl(m333getpVg5ArA2));
                if (invoke.compareTo(invoke2) > 0) {
                    m333getpVg5ArA = m333getpVg5ArA2;
                    invoke = invoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m674minByMShoTSo(long[] minBy, Function1<? super ULong, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(minBy, "$this$minBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (ULongArray.m415isEmptyimpl(minBy)) {
            return null;
        }
        long m412getsVKNKU = ULongArray.m412getsVKNKU(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(ULong.m346boximpl(m412getsVKNKU));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                long m412getsVKNKU2 = ULongArray.m412getsVKNKU(minBy, it.nextInt());
                R invoke2 = selector.invoke(ULong.m346boximpl(m412getsVKNKU2));
                if (invoke.compareTo(invoke2) > 0) {
                    m412getsVKNKU = m412getsVKNKU2;
                    invoke = invoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m673minByJOV_ifY(byte[] minBy, Function1<? super UByte, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(minBy, "$this$minBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UByteArray.m257isEmptyimpl(minBy)) {
            return null;
        }
        byte m254getw2LRezQ = UByteArray.m254getw2LRezQ(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UByte.m190boximpl(m254getw2LRezQ));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                byte m254getw2LRezQ2 = UByteArray.m254getw2LRezQ(minBy, it.nextInt());
                R invoke2 = selector.invoke(UByte.m190boximpl(m254getw2LRezQ2));
                if (invoke.compareTo(invoke2) > 0) {
                    m254getw2LRezQ = m254getw2LRezQ2;
                    invoke = invoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m676minByxTcfx_M(short[] minBy, Function1<? super UShort, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(minBy, "$this$minBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UShortArray.m520isEmptyimpl(minBy)) {
            return null;
        }
        short m517getMh2AYeg = UShortArray.m517getMh2AYeg(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UShort.m453boximpl(m517getMh2AYeg));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                short m517getMh2AYeg2 = UShortArray.m517getMh2AYeg(minBy, it.nextInt());
                R invoke2 = selector.invoke(UShort.m453boximpl(m517getMh2AYeg2));
                if (invoke.compareTo(invoke2) > 0) {
                    m517getMh2AYeg = m517getMh2AYeg2;
                    invoke = invoke2;
    ...
    public static final /* synthetic */ UInt m678minWithYmdZ_VM(int[] minWith, Comparator comparator) {
        ...
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1102minWithOrNullYmdZ_VM(minWith, comparator);
    }
    ...
    public static final /* synthetic */ ULong m680minWithzrEWJaI(long[] minWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(minWith, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1104minWithOrNullzrEWJaI(minWith, comparator);
    }
    ...
    public static final /* synthetic */ UByte m677minWithXMRcp5o(byte[] minWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(minWith, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1101minWithOrNullXMRcp5o(minWith, comparator);
    }
    ...
    public static final /* synthetic */ UShort m679minWitheOHTfZs(short[] minWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(minWith, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1103minWithOrNulleOHTfZs(minWith, comparator);
    }
    ...
    private static final BigDecimal sumOfBigDecimal(int[] sumOf, Function1<? super UInt, ? extends BigDecimal> selector) {
        ...
        int m334getSizeimpl = UIntArray.m334getSizeimpl(sumOf);
        for (int i = 0; i < m334getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UInt.m267boximpl(UIntArray.m333getpVg5ArA(sumOf, i))));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] sumOf, Function1<? super ULong, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m413getSizeimpl = ULongArray.m413getSizeimpl(sumOf);
        for (int i = 0; i < m413getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(ULong.m346boximpl(ULongArray.m412getsVKNKU(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] sumOf, Function1<? super UByte, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m255getSizeimpl = UByteArray.m255getSizeimpl(sumOf);
        for (int i = 0; i < m255getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UByte.m190boximpl(UByteArray.m254getw2LRezQ(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sumOf, Function1<? super UShort, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m518getSizeimpl = UShortArray.m518getSizeimpl(sumOf);
        for (int i = 0; i < m518getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UShort.m453boximpl(UShortArray.m517getMh2AYeg(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
