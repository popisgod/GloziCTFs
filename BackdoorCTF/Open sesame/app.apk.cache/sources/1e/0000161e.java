...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        ...
        if (Debug.getASSERTIONS_ENABLED() && this.resumeMode == -1) {
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                if (Debug.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                    ...
                    continuation.resumeWith(Result.m178constructorimpl(ResultKt.createFailure(cancellationException)));
                }
                cancellationException = cancellationException2;
                continuation.resumeWith(Result.m178constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m178constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m178constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
            }
            ...
            try {
                ...
                m178constructorimpl2 = Result.m178constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m181exceptionOrNullimpl(m178constructorimpl2));
        } catch (Throwable th2) {
            try {
            ...
            handleFatalException(th2, Result.m181exceptionOrNullimpl(m178constructorimpl));
        }
    }
