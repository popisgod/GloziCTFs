...
public class _Ranges extends RangesKt__RangesKt {
    ...
    public static final char first(Progressions progressions) {
        Intrinsics.checkNotNullParameter(progressions, "<this>");
        if (progressions.isEmpty()) {
            throw new NoSuchElementException("Progression " + progressions + " is empty.");
        }
        return progressions.getFirst();
    }
    ...
    public static final Character firstOrNull(Progressions progressions) {
        Intrinsics.checkNotNullParameter(progressions, "<this>");
        if (progressions.isEmpty()) {
            return null;
        }
        return Character.valueOf(progressions.getFirst());
    }
    ...
    public static final char last(Progressions progressions) {
        Intrinsics.checkNotNullParameter(progressions, "<this>");
        if (progressions.isEmpty()) {
            throw new NoSuchElementException("Progression " + progressions + " is empty.");
        }
        return progressions.getLast();
    }
    ...
    public static final Character lastOrNull(Progressions progressions) {
        Intrinsics.checkNotNullParameter(progressions, "<this>");
        if (progressions.isEmpty()) {
            return null;
        }
        return Character.valueOf(progressions.getLast());
    }
    ...
    private static final char random(PrimitiveRanges primitiveRanges) {
        Intrinsics.checkNotNullParameter(primitiveRanges, "<this>");
        return RangesKt.random(primitiveRanges, Random.Default);
    }
    ...
    public static final char random(PrimitiveRanges primitiveRanges, Random random) {
        Intrinsics.checkNotNullParameter(primitiveRanges, "<this>");
        Intrinsics.checkNotNullParameter(random, "random");
        try {
            return (char) random.nextInt(primitiveRanges.getFirst(), primitiveRanges.getLast() + 1);
        } catch (IllegalArgumentException e) {
            throw new NoSuchElementException(e.getMessage());
        }
    }
    ...
    private static final Character randomOrNull(PrimitiveRanges primitiveRanges) {
        Intrinsics.checkNotNullParameter(primitiveRanges, "<this>");
        return RangesKt.randomOrNull(primitiveRanges, Random.Default);
    }
    ...
    public static final Character randomOrNull(PrimitiveRanges primitiveRanges, Random random) {
        Intrinsics.checkNotNullParameter(primitiveRanges, "<this>");
        Intrinsics.checkNotNullParameter(random, "random");
        if (primitiveRanges.isEmpty()) {
            return null;
        }
        return Character.valueOf((char) random.nextInt(primitiveRanges.getFirst(), primitiveRanges.getLast() + 1));
    }
    ...
    private static final boolean contains(PrimitiveRanges primitiveRanges, Character ch) {
        Intrinsics.checkNotNullParameter(primitiveRanges, "<this>");
        return ch != null && primitiveRanges.contains(ch.charValue());
    }
    ...
    public static final Progressions step(Progressions progressions, int i) {
        Intrinsics.checkNotNullParameter(progressions, "<this>");
        RangesKt.checkStepIsPositive(i > 0, Integer.valueOf(i));
    ...
    public static final PrimitiveRanges until(char c, char c2) {
        return Intrinsics.compare((int) c2, 0) <= 0 ? PrimitiveRanges.Companion.getEMPTY() : new PrimitiveRanges(c, (char) (c2 - 1));
    }
