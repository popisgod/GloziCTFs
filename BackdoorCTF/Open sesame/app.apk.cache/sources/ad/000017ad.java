...
public final class FlowKt__LimitKt$transformWhile$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        C0935xdf1aa1b6 c0935xdf1aa1b6;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T> flow = this.$this_transformWhile;
            C0935xdf1aa1b6 c0935xdf1aa1b62 = new C0935xdf1aa1b6(this.$transform, (FlowCollector) this.L$0);
            try {
                this.L$0 = c0935xdf1aa1b62;
                this.label = 1;
                if (flow.collect(c0935xdf1aa1b62, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } catch (FlowExceptions e) {
                e = e;
                c0935xdf1aa1b6 = c0935xdf1aa1b62;
                FlowExceptions_commonKt.checkOwnership(e, c0935xdf1aa1b6);
                return Unit.INSTANCE;
            }
        } else if (i == 1) {
            c0935xdf1aa1b6 = (C0935xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);
