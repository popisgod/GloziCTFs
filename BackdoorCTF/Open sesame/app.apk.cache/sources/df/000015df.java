...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    public boolean isCancelled() {
        return getState$kotlinx_coroutines_core() instanceof CompletionState;
    }

    private final String getStateDebugRepresentation() {
        Object state$kotlinx_coroutines_core = getState$kotlinx_coroutines_core();
        return state$kotlinx_coroutines_core instanceof NotCompleted ? "Active" : state$kotlinx_coroutines_core instanceof CompletionState ? "Cancelled" : "Completed";
    }
    ...
    public final boolean resetStateReusable() {
        if (!Debug.getASSERTIONS_ENABLED() || this.resumeMode == 2) {
            if (Debug.getASSERTIONS_ENABLED() && this.parentHandle == NonDisposableHandle.INSTANCE) {
                throw new AssertionError();
            }
            Object obj = this._state;
            if (!Debug.getASSERTIONS_ENABLED() || (!(obj instanceof NotCompleted))) {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object obj, Throwable th) {
        while (true) {
            ...
            if (obj2 instanceof CompletedContinuation) {
                ...
                if (C0133xc40028dd.m146m(_state$FU, this, obj2, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, th, 15, null))) {
                    completedContinuation.invokeHandlers(this, th);
                    return;
                }
            } else if (C0133xc40028dd.m146m(_state$FU, this, obj2, new CompletedContinuation(obj2, null, null, null, th, 14, null))) {
                return;
            }
        }
    }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!C0133xc40028dd.m146m(_state$FU, this, obj, new CompletionState(this, th, z)));
    ...
    private final void callCancelHandlerSafely(Functions<Unit> functions) {
        try {
            functions.invoke();
        } catch (Throwable th) {
    ...
    public final Object getResult() {
            ...
            if (DispatchedTaskKt.isCancellableMode(this.resumeMode) && (job = (Job) getContext().get(Job.Key)) != null && !job.isActive()) {
                ...
                if (Debug.getRECOVER_STACK_TRACES()) {
                    ...
                    if (cancellableContinuationImpl instanceof CoroutineStackFrame) {
                        throw StackTraceRecovery.recoverFromStackFrame(cancellationException, cancellableContinuationImpl);
                    }
        ...
        if (Debug.getRECOVER_STACK_TRACES()) {
            ...
            if (cancellableContinuationImpl2 instanceof CoroutineStackFrame) {
                throw StackTraceRecovery.recoverFromStackFrame(th, cancellableContinuationImpl2);
            }
            throw th;
        }
        throw th;
    ...
    public void invokeOnCancellation(Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (C0133xc40028dd.m146m(_state$FU, this, obj, makeCancelHandler)) {
                    return;
                }
                ...
                if (z) {
                    ...
                    if (completedContinuation.getCancelled()) {
                        ...
                        if (C0133xc40028dd.m146m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, makeCancelHandler, null, null, null, 29, null))) {
                            return;
                        }
                    }
                    ...
                    if (C0133xc40028dd.m146m(_state$FU, this, obj, new CompletedContinuation(obj, makeCancelHandler, null, null, null, 28, null))) {
                        return;
                    }
                }
            }
    ...
    private final Object resumedState(NotCompleted notCompleted, Object obj, int i, Function1<? super Throwable, Unit> function1, Object obj2) {
        if (obj instanceof CompletedExceptionally) {
            if (!Debug.getASSERTIONS_ENABLED() || obj2 == null) {
                if (!Debug.getASSERTIONS_ENABLED() || function1 == null) {
                    return obj;
                }
                throw new AssertionError();
            }
    ...
    private final void resumeImpl(Object obj, int i, Function1<? super Throwable, Unit> function1) {
            ...
            if (obj2 instanceof NotCompleted) {
                ...
                if (obj2 instanceof CompletionState) {
                    ...
                    if (completionState.makeResumed()) {
                        if (function1 != null) {
                            callOnCancellation(function1, completionState.cause);
                            return;
                        }
                        return;
                    }
        ...
        } while (!C0133xc40028dd.m146m(_state$FU, this, obj2, resumedState((NotCompleted) obj2, obj, i, function1, null)));
        detachChildIfNonResuable();
        dispatchResume(i);
    }
    ...
    private final Symbol tryResumeImpl(Object obj, Object obj2, Function1<? super Throwable, Unit> function1) {
            ...
            if (obj3 instanceof NotCompleted) {
                ...
                if (obj2 != null) {
                    ...
                    if (completedContinuation.idempotentResume == obj2) {
                        if (!Debug.getASSERTIONS_ENABLED() || Intrinsics.areEqual(completedContinuation.result, obj)) {
        ...
        } while (!C0133xc40028dd.m146m(_state$FU, this, obj3, resumedState((NotCompleted) obj3, obj, this.resumeMode, function1, obj2)));
        detachChildIfNonResuable();
        return CancellableContinuationImplKt.RESUME_TOKEN;
    }
    ...
    public void completeResume(Object obj) {
        if (Debug.getASSERTIONS_ENABLED() && obj != CancellableContinuationImplKt.RESUME_TOKEN) {
            throw new AssertionError();
        }
        dispatchResume(this.resumeMode);
    }
    ...
    public Throwable getExceptionalResult$kotlinx_coroutines_core(Object obj) {
        ...
        if (exceptionalResult$kotlinx_coroutines_core != null) {
            Continuation<T> continuation = this.delegate;
            return (Debug.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) ? StackTraceRecovery.recoverFromStackFrame(exceptionalResult$kotlinx_coroutines_core, (CoroutineStackFrame) continuation) : exceptionalResult$kotlinx_coroutines_core;
        }
        return null;
    }
