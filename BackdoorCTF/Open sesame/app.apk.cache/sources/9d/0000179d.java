...
public final class FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r5 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1.C09331
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$1 r0 = (kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1.C09331) r0
            int r1 = r0.label
        ...
        L19:
            ...
            kotlin.ResultKt.throwOnFailure(r7)     // Catch: kotlinx.coroutines.flow.internal.FlowExceptions -> L2e
            goto L5c
        L2e:
            r7 = move-exception
            goto L57
        ...
        L38:
            ...
            r2.<init>(r4, r6)
            r6 = r2
            kotlinx.coroutines.flow.FlowCollector r6 = (kotlinx.coroutines.flow.FlowCollector) r6     // Catch: kotlinx.coroutines.flow.internal.FlowExceptions -> L55
            r0.L$0 = r2     // Catch: kotlinx.coroutines.flow.internal.FlowExceptions -> L55
            r0.label = r3     // Catch: kotlinx.coroutines.flow.internal.FlowExceptions -> L55
            java.lang.Object r6 = r7.collect(r6, r0)     // Catch: kotlinx.coroutines.flow.internal.FlowExceptions -> L55
            if (r6 != r1) goto L5c
            return r1
        L55:
            r7 = move-exception
