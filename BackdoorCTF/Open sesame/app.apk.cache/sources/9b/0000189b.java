...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation() {
        while (true) {
            ...
            if (obj == null) {
                ...
                if (C0133xc40028dd.m146m(_reusableCancellableContinuation$FU, this, obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                    return (CancellableContinuationImpl) obj;
                }
    ...
    public final Throwable tryReleaseClaimedContinuation(CancellableContinuation<?> cancellableContinuation) {
        do {
            ...
            if (obj != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (obj instanceof Throwable) {
                    if (!C0133xc40028dd.m146m(_reusableCancellableContinuation$FU, this, obj, null)) {
        ...
        } while (!C0133xc40028dd.m146m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, cancellableContinuation));
        return null;
    }
    ...
    public final boolean postponeCancellation(Throwable th) {
        while (true) {
            ...
            if (Intrinsics.areEqual(obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (C0133xc40028dd.m146m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, th)) {
                    return true;
                }
    ...
    public void resumeWith(Object obj) {
        ...
        if (this.dispatcher.isDispatchNeeded(context)) {
            ...
            this.resumeMode = 0;
            this.dispatcher.mo1783dispatch(context, this);
            return;
        }
        ...
        try {
            ...
            Object updateThreadContext = ThreadContext.updateThreadContext(context2, this.countOrElement);
            this.continuation.resumeWith(obj);
            Unit unit = Unit.INSTANCE;
            ThreadContext.restoreThreadContext(context2, updateThreadContext);
            do {
    ...
    public final void resumeCancellableWith(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        if (this.dispatcher.isDispatchNeeded(getContext())) {
            this._state = state;
            this.resumeMode = 1;
            this.dispatcher.mo1783dispatch(getContext(), this);
            return;
        }
        Debug.getASSERTIONS_ENABLED();
        EventLoop eventLoop$kotlinx_coroutines_core = ThreadLocalEventLoop.INSTANCE.getEventLoop$kotlinx_coroutines_core();
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                resumeWith(Result.m178constructorimpl(ResultKt.createFailure(cancellationException)));
            } else {
                Continuation<T> continuation = this.continuation;
                ...
                if (updateThreadContext != ThreadContext.NO_THREAD_ELEMENTS) {
                    undispatchedCoroutine = kotlinx.coroutines.CoroutineContext.updateUndispatchedCompletion(continuation, context, updateThreadContext);
                } else {
    ...
    public final void resumeUndispatchedWith(Object obj) {
        ...
        CoroutineContext context = continuation.getContext();
        Object updateThreadContext = ThreadContext.updateThreadContext(context, obj2);
        UndispatchedCoroutine<?> updateUndispatchedCompletion = updateThreadContext != ThreadContext.NO_THREAD_ELEMENTS ? kotlinx.coroutines.CoroutineContext.updateUndispatchedCompletion(continuation, context, updateThreadContext) : null;
        try {
            this.continuation.resumeWith(obj);
            Unit unit = Unit.INSTANCE;
        } finally {
