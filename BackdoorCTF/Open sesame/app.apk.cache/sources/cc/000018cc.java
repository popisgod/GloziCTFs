...
public final class StackTraceRecovery {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m178constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m178constructorimpl(ResultKt.createFailure(th));
        }
        ...
        try {
            ...
            obj2 = Result.m178constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m178constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m181exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
    ...
    public static final <E extends Throwable> E recoverStackTrace(E e) {
        ...
        return (Debug.getRECOVER_STACK_TRACES() && (tryCopyAndVerify = tryCopyAndVerify(e)) != null) ? (E) sanitizeStackTrace(tryCopyAndVerify) : e;
    }
    ...
    public static final <E extends Throwable> E recoverStackTrace(E e, Continuation<?> continuation) {
        return (Debug.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) ? (E) recoverFromStackFrame(e, (CoroutineStackFrame) continuation) : e;
    }

    public static final <E extends Throwable> E recoverFromStackFrame(E e, CoroutineStackFrame coroutineStackFrame) {
        Tuples causeAndStacktrace = causeAndStacktrace(e);
    ...
    private static final <E extends Throwable> Tuples<E, StackTraceElement[]> causeAndStacktrace(E e) {
        Throwable cause = e.getCause();
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            StackTraceElement[] stackTrace = e.getStackTrace();
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m18to(cause, stackTrace);
                }
            }
            return TuplesKt.m18to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m18to(e, new StackTraceElement[0]);
    }
    ...
    public static final <E extends Throwable> E unwrap(E e) {
        return !Debug.getRECOVER_STACK_TRACES() ? e : (E) unwrapImpl(e);
    }
