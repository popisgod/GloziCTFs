...
public class MotionController {
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        rectF.left = this.mStartMotionPath.f54x;
        rectF.top = this.mStartMotionPath.f55y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f54x;
        rectF2.top = this.mEndMotionPath.f55y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float f = this.mEndMotionPath.f54x - this.mStartMotionPath.f54x;
        float f2 = this.mEndMotionPath.f55y - this.mStartMotionPath.f55y;
        float f3 = this.mStartMotionPath.f54x + (this.mStartMotionPath.width / 2.0f);
        float f4 = this.mStartMotionPath.f55y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i16 = 0; i16 < i; i16++) {
                ...
                dArr7[i16][0] = motionPathsArr[i16].f54x;
                dArr7[i16][1] = motionPathsArr[i16].f55y;
            }
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            i = 1;
            float f5 = this.mStartMotionPath.f54x + ((this.mEndMotionPath.f54x - this.mStartMotionPath.f54x) * f4);
            float f6 = f5 + 0.5f;
            int i4 = (int) f6;
            float f7 = this.mStartMotionPath.f55y + ((this.mEndMotionPath.f55y - this.mStartMotionPath.f55y) * f4) + 0.5f;
            int i5 = (int) f7;
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float f2 = this.mEndMotionPath.f54x - this.mStartMotionPath.f54x;
        float f3 = this.mEndMotionPath.f55y - this.mStartMotionPath.f55y;
