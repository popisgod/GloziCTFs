...
public class MaterialColors {
    ...
    public static int harmonizeWithPrimary(Context context, int i) {
        return harmonize(i, getColor(context, C0572R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    public static boolean isLightTheme(Context context) {
        return MaterialAttributes.resolveBoolean(context, C0572R.attr.isLightTheme, true);
    }
