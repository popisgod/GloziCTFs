...
public final /* synthetic */ class BuildersKt__Builders_commonKt {
    ...
    public static final Job launch(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        CoroutineContext newCoroutineContext = CoroutineContext.newCoroutineContext(coroutineScope, coroutineContext);
    ...
    public static final <T> Object withContext(CoroutineContext coroutineContext, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        CoroutineContext newCoroutineContext = CoroutineContext.newCoroutineContext(context, coroutineContext);
        JobKt.ensureActive(newCoroutineContext);
        if (newCoroutineContext == context) {
            ScopeCoroutine scopeCoroutine = new ScopeCoroutine(newCoroutineContext, continuation);
            result = Undispatched.startUndispatchedOrReturn(scopeCoroutine, scopeCoroutine, function2);
            ...
            Object updateThreadContext = ThreadContext.updateThreadContext(newCoroutineContext, null);
            try {
                ...
                ThreadContext.restoreThreadContext(newCoroutineContext, updateThreadContext);
            ...
            Cancellable.startCoroutineCancellable$default(function2, dispatchedCoroutine, dispatchedCoroutine, null, 4, null);
