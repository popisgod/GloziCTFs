...
public class ConstraintAttribute {
    ...
    public boolean isContinuous() {
        int i = C01751.f57x66adad53[this.mType.ordinal()];
    ...
    public static void parse(Context context, XmlPullParser parser, HashMap<String, ConstraintAttribute> custom) {
        ...
        Object valueOf;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0177R.styleable.CustomAttribute);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == C0177R.styleable.CustomAttribute_attributeName) {
            ...
            } else if (index == C0177R.styleable.CustomAttribute_methodName) {
                str = obtainStyledAttributes.getString(index);
                z = true;
                ...
                } else if (index == C0177R.styleable.CustomAttribute_customReference) {
