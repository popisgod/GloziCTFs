...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (i == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0182R.styleable.CoordinatorLayout, 0, C0182R.style.Widget_Support_CoordinatorLayout);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0182R.styleable.CoordinatorLayout, i, 0);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            if (i == 0) {
                saveAttributeDataForStyleable(context, C0182R.styleable.CoordinatorLayout, attributeSet, obtainStyledAttributes, 0, C0182R.style.Widget_Support_CoordinatorLayout);
            } else {
                saveAttributeDataForStyleable(context, C0182R.styleable.CoordinatorLayout, attributeSet, obtainStyledAttributes, i, 0);
            }
        }
        int resourceId = obtainStyledAttributes.getResourceId(C0182R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = obtainStyledAttributes.getDrawable(C0182R.styleable.CoordinatorLayout_statusBarBackground);
