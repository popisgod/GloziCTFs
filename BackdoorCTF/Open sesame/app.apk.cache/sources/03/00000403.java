...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setState(TransitionState newState) {
        ...
        int i = C01615.f52xabc7e4ac[transitionState.ordinal()];
        if (i == 1 || i == 2) {
    ...
    */
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attrs, C0177R.styleable.MotionLayout);
    ...
    public void updateStateAnimate(int stateId, ConstraintSet set, int duration) {
        if (this.mScene != null && this.mCurrentState == stateId) {
            ...
            MotionScene.Transition transition = new MotionScene.Transition(-1, this.mScene, C0177R.C0180id.view_transition, stateId);
