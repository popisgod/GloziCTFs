...
public abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public DateFormatTextWatcher(final String str, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C0572R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher$$ExternalSyntheticLambda0
            {
                DateFormatTextWatcher.this = this;
            }

            @Override // java.lang.Runnable
            public final void run() {
                DateFormatTextWatcher.this.m67x5657fb8e(str);
            }
        };
    }
    ...
    public /* synthetic */ void m67x5657fb8e(String str) {
        TextInputLayout textInputLayout = this.textInputLayout;
        DateFormat dateFormat = this.dateFormat;
        Context context = textInputLayout.getContext();
        String string = context.getString(C0572R.string.mtrl_picker_invalid_format);
        String format = String.format(context.getString(C0572R.string.mtrl_picker_invalid_format_use), sanitizeDateString(str));
        textInputLayout.setError(string + "\n" + format + "\n" + String.format(context.getString(C0572R.string.mtrl_picker_invalid_format_example), sanitizeDateString(dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())))));
        onInvalidDate();
    }
    ...
    private Runnable createRangeErrorCallback(final long j) {
        return new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher$$ExternalSyntheticLambda1
            ...
            @Override // java.lang.Runnable
            public final void run() {
                DateFormatTextWatcher.this.m68x14d77527(j);
            }
        };
    }
    ...
    public /* synthetic */ void m68x14d77527(long j) {
