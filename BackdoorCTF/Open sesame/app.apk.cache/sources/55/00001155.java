...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C0572R.attr.materialTimePickerStyle, C0572R.style.Widget_MaterialComponents_TimePicker);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0572R.styleable.MaterialTimePicker, C0572R.attr.materialTimePickerStyle, C0572R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = obtainStyledAttributes.getResourceId(C0572R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = obtainStyledAttributes.getResourceId(C0572R.styleable.MaterialTimePicker_keyboardIcon, 0);
        int color = obtainStyledAttributes.getColor(C0572R.styleable.MaterialTimePicker_backgroundTint, 0);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C0572R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(C0572R.C0575id.material_timepicker_view);
        this.timePickerView = timePickerView;
        timePickerView.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C0572R.C0575id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C0572R.C0575id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C0572R.C0575id.header_title);
        ...
        Button button = (Button) viewGroup2.findViewById(C0572R.C0575id.material_timepicker_ok_button);
        ...
        Button button2 = (Button) viewGroup2.findViewById(C0572R.C0575id.material_timepicker_cancel_button);
        ...
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            view.postDelayed(new Runnable() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    MaterialTimePicker.this.m30xac73da03();
                }
            }, 100L);
        }
    }
    ...
    public /* synthetic */ void m30xac73da03() {
        TimePickerPresenter timePickerPresenter = this.activePresenter;
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        if (i != 0) {
            if (i == 1) {
                return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C0572R.string.material_timepicker_clock_mode_description));
            }
            throw new IllegalArgumentException("no icon for mode: " + i);
        }
        return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C0572R.string.material_timepicker_text_input_mode_description));
    }
    ...
    private int getThemeResId() {
        ...
        TypedValue resolve = MaterialAttributes.resolve(requireContext(), C0572R.attr.materialTimePickerTheme);
        if (resolve == null) {
            return 0;
        }
        return resolve.data;
