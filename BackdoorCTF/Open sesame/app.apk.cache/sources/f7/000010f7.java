...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int DEF_STYLE_RES = C0572R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0572R.attr.tabStyle);
    }
    ...
    */
    ...
    public Tab newTab() {
        ...
        if (createTabFromPool.f203id != -1) {
            createTabFromPool.view.setId(createTabFromPool.f203id);
        }
    ...
    public final class TabView extends LinearLayout {
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0572R.layout.design_layout_tab_icon, (ViewGroup) frameLayout, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0572R.layout.design_layout_tab_text, (ViewGroup) frameLayout, false);
