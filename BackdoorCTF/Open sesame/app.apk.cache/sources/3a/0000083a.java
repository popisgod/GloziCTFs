...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0188R.attr.nestedScrollViewStyle);
    }
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (z) {
                            ...
                            int i8 = scrollY + i7;
                            if (i8 < 0) {
                                EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, (-i7) / getHeight(), motionEvent.getX(findPointerIndex) / getWidth());
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i8 > scrollRange) {
                                EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, i7 / getHeight(), 1.0f - (motionEvent.getX(findPointerIndex) / getWidth()));
