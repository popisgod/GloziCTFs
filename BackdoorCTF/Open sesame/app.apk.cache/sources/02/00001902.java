...
public final class SelectKt {
    ...
    public static final <R> void m1723onTimeout8Mi8wO0(Select<? super R> select, long j, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        select.onTimeout(DelayKt.m1658toDelayMillisLRDsOJo(j), function1);
    }

    private static final <R> Object select$$forInline(Function1<? super Select<? super R>, Unit> function1, Continuation<? super R> continuation) {
        InlineMarker.mark(0);
    ...
    public static final <R> Object select(Function1<? super Select<? super R>, Unit> function1, Continuation<? super R> continuation) {
        SelectBuilderImpl selectBuilderImpl = new SelectBuilderImpl(continuation);
        try {
            function1.invoke(selectBuilderImpl);
        } catch (Throwable th) {
