...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        /* renamed from: $r8$lambda$f9aU52V4hLVPTW2v-TcMiSk5YDc */
        public static /* synthetic */ boolean m159$r8$lambda$f9aU52V4hLVPTW2vTcMiSk5YDc(ComponentName componentName, Object obj) {
        ...
        public Builder allowAction(Predicate<String> predicate) {
            ...
            this.mAllowedActions = this.mAllowedActions.m117or(predicate);
            return this;
        }
        ...
        public Builder allowData(Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedData = this.mAllowedData.m117or(predicate);
            return this;
        }
        ...
        public Builder allowType(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedTypes = this.mAllowedTypes.m117or(predicate);
            return this;
        }
        ...
        public Builder allowCategory(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedCategories = this.mAllowedCategories.m117or(predicate);
            return this;
        }
        ...
        public Builder allowPackage(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedPackages = this.mAllowedPackages.m117or(predicate);
            return this;
        }
        ...
        public Builder allowComponent(final ComponentName componentName) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda9
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return IntentSanitizer.Builder.m159$r8$lambda$f9aU52V4hLVPTW2vTcMiSk5YDc(componentName, (ComponentName) obj);
                }
            });
        }
        ...
        public Builder allowComponent(Predicate<ComponentName> predicate) {
            ...
            this.mAllowedComponents = this.mAllowedComponents.m117or(predicate);
            return this;
        }
        ...
        public Builder allowClipDataUri(Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipDataUri = this.mAllowedClipDataUri.m117or(predicate);
            return this;
        }

        public Builder allowClipData(Predicate<ClipData> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipData = this.mAllowedClipData.m117or(predicate);
            return this;
        }
        ...
        public Builder allowExtra(String str, Predicate<Object> predicate) {
            ...
            this.mAllowedExtras.put(str, predicate2.m117or(predicate));
            return this;
        }
