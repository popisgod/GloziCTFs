...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    /* compiled from: CoroutineScheduler.kt */
    @Metadata(m26d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0007\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, m25d2 = {"Lkotlinx/coroutines/scheduling/CoroutineScheduler$WorkerState;", "", "(Ljava/lang/String;I)V", "CPU_ACQUIRED", "BLOCKING", "PARKING", "DORMANT", "TERMINATED", "kotlinx-coroutines-core"}, m24k = 1, m23mv = {1, 6, 0}, m21xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    public final boolean parkedWorkersStackPush(Worker worker) {
        ...
        do {
            ...
            if (Debug.getASSERTIONS_ENABLED() && indexInArray == 0) {
    ...
    /* compiled from: CoroutineScheduler.kt */
    @Metadata(m26d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0006X\u0080T¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0006X\u0080T¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u00020\u000e8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0010\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0012\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0014"}, m25d2 = {"Lkotlinx/coroutines/scheduling/CoroutineScheduler$Companion;", "", "()V", "BLOCKING_MASK", "", "BLOCKING_SHIFT", "", "CLAIMED", "CPU_PERMITS_MASK", "CPU_PERMITS_SHIFT", "CREATED_MASK", "MAX_SUPPORTED_POOL_SIZE", "MIN_SUPPORTED_POOL_SIZE", "NOT_IN_STACK", "Lkotlinx/coroutines/internal/Symbol;", "PARKED", "PARKED_INDEX_MASK", "PARKED_VERSION_INC", "PARKED_VERSION_MASK", "TERMINATED", "kotlinx-coroutines-core"}, m24k = 1, m23mv = {1, 6, 0}, m21xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    public final void shutdown(long j) {
        ...
        if (_isTerminated$FU.compareAndSet(this, 0, 1)) {
            ...
            if (1 <= i) {
                ...
                while (true) {
                    ...
                    if (worker2 != currentWorker) {
                        ...
                        if (Debug.getASSERTIONS_ENABLED() && workerState != WorkerState.TERMINATED) {
                            throw new AssertionError();
                        }
            ...
            if (Debug.getASSERTIONS_ENABLED() && ((int) ((this.controlState & CPU_PERMITS_MASK) >> 42)) != this.corePoolSize) {
                throw new AssertionError();
            }
            this.parkedWorkersStack = 0L;
    ...
    public final class Worker extends Thread {
        ...
        private final void tryPark() {
            ...
            } else if (Debug.getASSERTIONS_ENABLED() && this.localQueue.getSize$kotlinx_coroutines_core() != 0) {
                throw new AssertionError();
            } else {
                this.workerCtl = -1;
        ...
        private final void idleReset(int i) {
            ...
            if (this.state == WorkerState.PARKING) {
                if (Debug.getASSERTIONS_ENABLED() && i != 1) {
                    throw new AssertionError();
                }
        ...
        private final Task trySteal(boolean z) {
            long tryStealFrom;
            if (!Debug.getASSERTIONS_ENABLED() || this.localQueue.getSize$kotlinx_coroutines_core() == 0) {
        ...
        private final void afterTask(int i) {
            ...
            if (workerState != WorkerState.TERMINATED) {
                if (Debug.getASSERTIONS_ENABLED() && workerState != WorkerState.BLOCKING) {
                    throw new AssertionError();
                }
                this.state = WorkerState.DORMANT;
            }
