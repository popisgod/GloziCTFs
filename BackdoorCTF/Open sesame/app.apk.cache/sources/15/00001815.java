...
public final class C0975xd7c321e8<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public C0975xd7c321e8(Flow[] flowArr, Continuation continuation, Function5 function5) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        C0975xd7c321e8 c0975xd7c321e8 = new C0975xd7c321e8(this.$flows, continuation, this.$transform$inlined);
        c0975xd7c321e8.L$0 = obj;
        return c0975xd7c321e8;
    }
    ...
    public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        return ((C0975xd7c321e8) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* loaded from: classes.dex */
    public static final class C09761 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
        final /* synthetic */ Function5 $transform$inlined;
        private /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C09761(Continuation continuation, Function5 function5) {
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
            C09761 c09761 = new C09761(continuation, this.$transform$inlined);
            c09761.L$0 = flowCollector;
            c09761.L$1 = objArr;
            return c09761.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (Combine.combineInternal((FlowCollector) this.L$0, flowArr, nullArrayFactory$FlowKt__ZipKt, new C09761(null, this.$transform$inlined), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
