...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo1783dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo1783dispatch(coroutineContext, runnable);
        }
    }
