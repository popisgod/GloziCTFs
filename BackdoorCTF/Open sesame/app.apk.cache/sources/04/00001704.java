...
public interface SendChannel<E> {
    ...
    Object mo1669trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1684isSuccessimpl(mo1669trySendJP2dKIU)) {
                return true;
            }
            Throwable m1678exceptionOrNullimpl = ChannelResult.m1678exceptionOrNullimpl(mo1669trySendJP2dKIU);
            if (m1678exceptionOrNullimpl == null) {
                return false;
            }
            throw StackTraceRecovery.recoverStackTrace(m1678exceptionOrNullimpl);
        }
    }
}