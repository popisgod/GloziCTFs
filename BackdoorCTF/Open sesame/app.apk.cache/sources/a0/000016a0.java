...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    private final void enqueueElement(int i, E e) {
        ...
        } else if (Debug.getASSERTIONS_ENABLED() && this.onBufferOverflow != BufferOverflow.DROP_OLDEST) {
    ...
    */
    protected java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r9) {
        ...
        L2b:
            ...
            r7 = r3
            kotlinx.coroutines.internal.AtomicDesc r7 = (kotlinx.coroutines.internal.Atomic) r7     // Catch: java.lang.Throwable -> Lcb
