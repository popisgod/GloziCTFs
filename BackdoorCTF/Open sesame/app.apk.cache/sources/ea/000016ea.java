...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    /* compiled from: ConflatedBroadcastChannel.kt */
    @Metadata(m26d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0007\b\u0002\u0018\u00002\u00020\u0001B\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004R\u0012\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007R\u0011\u0010\b\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\t\u0010\u0007¨\u0006\n"}, m25d2 = {"Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Closed;", "", "closeCause", "", "(Ljava/lang/Throwable;)V", "sendException", "getSendException", "()Ljava/lang/Throwable;", "valueException", "getValueException", "kotlinx-coroutines-core"}, m24k = 1, m23mv = {1, 6, 0}, m21xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!C0133xc40028dd.m146m(_state$FU, this, obj, new State(state.value, addSubscriber(state.subscribers, subscriber))));
        return subscriber;
    }
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        } while (!C0133xc40028dd.m146m(_state$FU, this, obj, new State(obj2, removeSubscriber(subscriberArr, subscriber))));
    }
    ...
    private final Subscriber<E>[] removeSubscriber(Subscriber<E>[] subscriberArr, Subscriber<E> subscriber) {
        ...
        if (!Debug.getASSERTIONS_ENABLED() || indexOf >= 0) {
            if (length == 1) {
                return null;
            }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!C0133xc40028dd.m146m(_state$FU, this, obj, th == null ? CLOSED : new Closed(th)));
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if ((obj2 instanceof Closed) && C0133xc40028dd.m146m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo1669trySendJP2dKIU(E e) {
        Closed offerInternal = offerInternal(e);
        return offerInternal != null ? ChannelResult.Companion.m1687closedJP2dKIU(offerInternal.getSendException()) : ChannelResult.Companion.m1689successJP2dKIU(Unit.INSTANCE);
    }
    ...
    private final Closed offerInternal(E e) {
        ...
        if (_updating$FU.compareAndSet(this, 0, 1)) {
            ...
            } while (!C0133xc40028dd.m146m(_state$FU, this, obj, new State(e, ((State) obj).subscribers)));
            Subscriber<E>[] subscriberArr = ((State) obj).subscribers;
            if (subscriberArr != null) {
                for (Subscriber<E> subscriber : subscriberArr) {
