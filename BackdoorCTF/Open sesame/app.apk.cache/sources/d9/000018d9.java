...
public class ThreadSafeHeap<T extends ThreadSafeHeapNode & Comparable<? super T>> {
    ...
    public final T removeAtImpl(int i) {
        if (!Debug.getASSERTIONS_ENABLED() || getSize() > 0) {
            T[] tArr = this.f234a;
            ...
            if (!Debug.getASSERTIONS_ENABLED() || t3.getHeap() == this) {
                t3.setHeap(null);
                t3.setIndex(-1);
                tArr[getSize()] = null;
                return t3;
    ...
    public final void addImpl(T t) {
        if (Debug.getASSERTIONS_ENABLED() && t.getHeap() != null) {
            throw new AssertionError();
        }
        t.setHeap(this);
        T[] realloc = realloc();
    ...
    */
    private final void siftDownFrom(int r6) {
        ...
        L0:
            ...
            return
        Lb:
            T extends kotlinx.coroutines.internal.ThreadSafeHeapNode & java.lang.Comparable<? super T>[] r2 = r5.f234a
    ...
    public final boolean remove(T t) {
        ...
        synchronized (this) {
            if (t.getHeap() == null) {
                ...
                if (Debug.getASSERTIONS_ENABLED() && index < 0) {
                    throw new AssertionError();
                }
                removeAtImpl(index);
                z = true;
