...
public final /* synthetic */ class Share {
    ...
    */
    private static final <T> kotlinx.coroutines.flow.SharingConfig<T> configureSharing$FlowKt__ShareKt(kotlinx.coroutines.flow.Flow<? extends T> r6, int r7) {
        /*
            boolean r0 = kotlinx.coroutines.Debug.getASSERTIONS_ENABLED()
            if (r0 == 0) goto Lf
            if (r7 < 0) goto L9
            goto Lf
        L9:
        ...
        L4f:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.Share.configureSharing$FlowKt__ShareKt(kotlinx.coroutines.flow.Flow, int):kotlinx.coroutines.flow.SharingConfig");
    }
