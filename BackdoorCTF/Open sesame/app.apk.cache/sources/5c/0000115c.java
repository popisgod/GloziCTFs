...
public class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0572R.layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0572R.styleable.RadialViewGroup, i, 0);
        this.radius = obtainStyledAttributes.getDimensionPixelSize(C0572R.styleable.RadialViewGroup_materialCircleRadius, 0);
    ...
    public void updateLayoutParams() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt.getId() != C0572R.C0575id.circle_center && !shouldSkipView(childAt)) {
                int i2 = (Integer) childAt.getTag(C0572R.C0575id.material_clock_level);
                if (i2 == null) {
                    i2 = 1;
                }
    ...
    private void addConstraints(List<View> list, ConstraintSet constraintSet, int i) {
        float f = 0.0f;
        for (View view : list) {
            constraintSet.constrainCircle(view.getId(), C0572R.C0575id.circle_center, i, f);
            f += 360.0f / list.size();
        }
    }
