...
public final class MutexKt {
    ...
    */
    public static final <T> java.lang.Object withLock(kotlinx.coroutines.sync.Mutex r4, java.lang.Object r5, kotlin.jvm.functions.Functions<? extends T> r6, kotlin.coroutines.Continuation<? super T> r7) {
        /*
    ...
    private static final <T> Object withLock$$forInline(Mutex mutex, Object obj, Functions<? extends T> functions, Continuation<? super T> continuation) {
        InlineMarker.mark(0);
    ...
    public static /* synthetic */ Object withLock$default(Mutex mutex, Object obj, Functions functions, Continuation continuation, int i, Object obj2) {
        if ((i & 1) != 0) {
            obj = null;
        }
        InlineMarker.mark(0);
