...
public final class Produce {
    ...
    */
    public static final java.lang.Object awaitClose(kotlinx.coroutines.channels.ProducerScope<?> r4, kotlin.jvm.functions.Functions<kotlin.Unit> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
        ...
        L3d:
            ...
            kotlin.coroutines.jvm.internal.DebugProbes.probeCoroutineSuspended(r0)     // Catch: java.lang.Throwable -> L33
        L7f:
            if (r4 != r1) goto L82
            return r1
        L82:
        ...
        L8c:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.Produce.awaitClose(kotlinx.coroutines.channels.ProducerScope, kotlin.jvm.functions.Function0, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public static /* synthetic */ Object awaitClose$default(ProducerScope producerScope, Functions functions, Continuation continuation, int i, Object obj) {
        if ((i & 1) != 0) {
            functions = new Functions<Unit>() { // from class: kotlinx.coroutines.channels.ProduceKt$awaitClose$2
                /* renamed from: invoke */
        ...
        return awaitClose(producerScope, functions, continuation);
    }
    ...
    public static final <E> ReceiveChannel<E> produce(CoroutineScope coroutineScope, CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow, CoroutineStart coroutineStart, Function1<? super Throwable, Unit> function1, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ProducerCoroutine producerCoroutine = new ProducerCoroutine(kotlinx.coroutines.CoroutineContext.newCoroutineContext(coroutineScope, coroutineContext), ChannelKt.Channel$default(i, bufferOverflow, null, 4, null));
        if (function1 != null) {
