...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f18x = (int) ((f8 + (f10 * f)) - f13);
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f19y = (int) ((f9 + (f11 * f)) - f15);
        ...
        this.mMode = 0;
        this.f18x = (int) (((motionPaths.f18x + (f16 * f10)) + (f18 * f11)) - f13);
        this.f19y = (int) (((motionPaths.f19y + (f10 * f17)) + (f11 * f)) - f15);
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = motionPaths.f19y;
        float f11 = motionPaths.height;
        float f12 = (motionPaths2.f18x + (motionPaths2.width / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = (motionPaths2.f19y + (motionPaths2.height / 2.0f)) - ((f11 / 2.0f) + f10);
        float f14 = f12 * f3;
        float f15 = (f6 * f4) / 2.0f;
        this.f18x = (int) ((f8 + f14) - f15);
        float f16 = f3 * f13;
        float f17 = (f7 * f5) / 2.0f;
        this.f19y = (int) ((f10 + f16) - f17);
        this.width = (int) (f9 + f);
        this.height = (int) (f11 + f2);
        float f18 = Float.isNaN(motionKeyPosition.mPercentY) ? 0.0f : motionKeyPosition.mPercentY;
        this.mMode = 1;
        float f19 = (int) ((motionPaths.f18x + f14) - f15);
        this.f18x = f19;
        float f20 = (int) ((motionPaths.f19y + f16) - f17);
        this.f18x = f19 + ((-f13) * f18);
        this.f19y = f20 + (f12 * f18);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    }
