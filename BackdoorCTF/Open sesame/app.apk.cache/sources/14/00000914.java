...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            this.f83bb = byteBuffer;
            byteBuffer.clear();
            this.f83bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f83bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
    ...
    public void prep(int i, int i2) {
        ...
        int i3 = ((~((this.f83bb.capacity() - this.space) + i2)) + 1) & (i - 1);
        while (this.space < i3 + i + i2) {
            int capacity = this.f83bb.capacity();
            ByteBuffer byteBuffer = this.f83bb;
            ...
            this.space += this.f83bb.capacity() - capacity;
        }
        pad(i3);
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f83bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f83bb);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int capacity = this.f83bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f83bb.getShort(capacity);
            if (s == this.f83bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f83bb.getShort(capacity + i7) != this.f83bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int capacity2 = this.f83bb.capacity() - offset;
            this.space = capacity2;
            this.f83bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f83bb.capacity() - i;
        if (this.f83bb.getShort((capacity - this.f83bb.getInt(capacity)) + i2) == 0) {
